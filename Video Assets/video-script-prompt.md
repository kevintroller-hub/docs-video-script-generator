...
#Example 1
Hi there!
Today, we're going to talk about protecting application property values in [Product Name] through [Product Name]. This is a crucial step for ensuring the security of your application's sensitive information.
These protected application values are encrypted and stored in the [platform] secrets manager.

Before you begin, make sure you have the prerequisites in place. You need:
An active [Your Platform] account.
A application.
...
And you are all set to protect your propertie's values.
Thank you for watching and see you in the next video!


#Example 2
Hey there!
Today, we're going to talk about reviewing application versioning for [Product Name] using [Product Name]. 
...
Before you begin, make sure you have the prerequisites in place. You need:
An [Your Platform] account.
A deployed application to [Product Name].
VIEW CONFIGURATION CHANGE HISTORY
Now, sign into [Your Platform] and go to [Product Name].
In the navigation menu, click Applications, and select a application deployed to [Product Name].
...
Once the configuration is successfully applied and deployed, the message Desired configuration applied successfully appears at the top of the screen.
...
By using application versioning on [Product Name], you can maintain a clear history of your app's changes, perform smooth updates, and quickly revert to previous versions if needed. This makes your app management more efficient and reliable.
Thank you for watching and see you in the next video!
